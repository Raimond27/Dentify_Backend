 ...
 */
final class Version20260309143720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE box (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE cita (id INT AUTO_INCREMENT NOT NULL, fecha DATE NOT NULL, hora_inicio TIME NOT NULL, duracion VARCHAR(50) NOT NULL, estado VARCHAR(50) NOT NULL, prioridad INT NOT NULL, paciente_id INT NOT NULL, odontologo_id INT NOT NULL, box_id INT NOT NULL, INDEX IDX_3E379A627310DAD4 (paciente_id), INDEX IDX_3E379A62C1C6A359 (odontologo_id), INDEX IDX_3E379A62D8177B3F (box_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE horario (id INT AUTO_INCREMENT NOT NULL, dia_semana VARCHAR(20) NOT NULL, fecha DATE NOT NULL, hora_inicio TIME NOT NULL, hora_fin TIME NOT NULL, odontologo_id INT NOT NULL, INDEX IDX_E25853A3C1C6A359 (odontologo_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE odontograma (id INT AUTO_INCREMENT NOT NULL, dientes JSON NOT NULL, fecha_creacion DATETIME NOT NULL, fecha_modificacion DATETIME DEFAULT NULL, paciente_id INT NOT NULL, INDEX IDX_9E4EE42A7310DAD4 (paciente_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE odontologo (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, especialidad VARCHAR(255) DEFAULT NULL, dia_semana_asignado VARCHAR(50) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE paciente (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, dni VARCHAR(20) NOT NULL, numero_seguridad_social VARCHAR(255) DEFAULT NULL, telefono VARCHAR(20) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, datos_facturacion VARCHAR(255) DEFAULT NULL, alergias JSON DEFAULT NULL, fecha_creacion DATETIME NOT NULL, fecha_modificacion DATETIME DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE patologia (id INT AUTO_INCREMENT NOT NULL, diente INT NOT NULL, cara VARCHAR(50) NOT NULL, tipo_patologia VARCHAR(255) NOT NULL, estado VARCHAR(50) NOT NULL, color VARCHAR(50) NOT NULL, prioridad INT NOT NULL, odontograma_id INT NOT NULL, INDEX IDX_17FB1F75F8ED5CE7 (odontograma_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE protocolo_tratamiento (id INT AUTO_INCREMENT NOT NULL, nombre_tratamiento VARCHAR(255) NOT NULL, notas_paso_apaso LONGTEXT DEFAULT NULL, cantidad_necesaria NUMERIC(10, 2) DEFAULT NULL, material_id INT DEFAULT NULL, INDEX IDX_FE29C314E308AC6F (material_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE radiografia (id INT AUTO_INCREMENT NOT NULL, nombre_archivo VARCHAR(255) NOT NULL, tipo_radiografia VARCHAR(100) DEFAULT NULL, fecha_subida DATETIME NOT NULL, observaciones LONGTEXT DEFAULT NULL, activa TINYINT NOT NULL, paciente_id INT NOT NULL, INDEX IDX_9790483D7310DAD4 (paciente_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE recepcion_material (id INT AUTO_INCREMENT NOT NULL, cantidad NUMERIC(10, 2) NOT NULL, proveedor VARCHAR(255) DEFAULT NULL, fecha DATETIME NOT NULL, material_id INT NOT NULL, INDEX IDX_19046833E308AC6F (material_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE stock_material (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, cantidad NUMERIC(10, 2) NOT NULL, unidad VARCHAR(50) NOT NULL, fecha_ultima_reposicion DATETIME DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE horario ADD CONSTRAINT FK_E25853A3C1C6A359 FOREIGN KEY (odontologo_id) REFERENCES odontologo (id)');
        ...
        $this->addSql('ALTER TABLE patologia ADD CONSTRAINT FK_17FB1F75F8ED5CE7 FOREIGN KEY (odontograma_id) REFERENCES odontograma (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE protocolo_tratamiento ADD CONSTRAINT FK_FE29C314E308AC6F FOREIGN KEY (material_id) REFERENCES stock_material (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE horario DROP FOREIGN KEY FK_E25853A3C1C6A359');
        $this->addSql('ALTER TABLE odontograma DROP FOREIGN KEY FK_9E4EE42A7310DAD4');
        $this->addSql('ALTER TABLE patologia DROP FOREIGN KEY FK_17FB1F75F8ED5CE7');
        ...
        $this->addSql('ALTER TABLE protocolo_tratamiento DROP FOREIGN KEY FK_FE29C314E308AC6F');
